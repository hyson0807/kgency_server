...
router.post('/create-general-room', authMiddleware, chatController.createGeneralChatRoom);
...
router.get('/room/:roomId/permission', authMiddleware, chatController.checkUserChatPermission);
